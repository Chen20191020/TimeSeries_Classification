...
lfreg = function(formula, betalist = NULL){
  ...
  for(i in 1:iter){
    ...
    #print(paste("Matrix Rank:", rank_Z))
    #print(paste("Total Columns:", cols_Z))
    
    #if (rank_Z < cols_Z) {
    #  print("ALERT: Matrix is Rank Deficient!")
    #  print(paste("Number of redundant columns:", cols_Z - rank_Z))
    #} else {
    #  print("Matrix is Full Rank (Safe).")
    # }
