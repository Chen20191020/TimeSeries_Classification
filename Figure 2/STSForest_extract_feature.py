...
class rstsf():
    ...
    def fit(self, X_train_ori, y_train_ori):
        ...
        return features_importances, all_X_train_T
...
simu_train = simu_train.reshape(200, 1024)
clf = rstsf()
res_impor, res_Xtrain = clf.fit(simu_train, Y_label)

# the features used in the boxplot 
simu_test = simu_test.reshape(50, 1024)
res_pre, res_Xtest = clf.predict(simu_test)
feature = res_Xtest[:, np.argmax(res_impor)]
print(feature)