...
sim_func_auto_faster_L2Dis = function(Train_list, Testing_list, c = 25, b = 1, m = 500) {
  ...
  train_class1 = length(Train_list) / 6
  train_class2 = 5*length(Train_list) / 6
...
for(case in 7:7){
  ...
  res = c()
  for(j in 1:500){
    res[j] = sim_func_without_auto_faster(1024, case, 2, 1, 8, 1, 50, 250, 25, 25)
  }
